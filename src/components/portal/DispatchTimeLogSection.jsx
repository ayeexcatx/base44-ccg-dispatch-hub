      ...
      {isOwner && showOwnerAssignmentsAndTimeLogs && myTrucks.length > 0 && dispatchStatus !== 'Cancelled' && (
        ...
        >
          ...
          <p className="mb-3 text-xs text-slate-500">
            Please enter the time your truck checked in/out for this dispatch below. Drivers do not have access to this section. You must enter the times given to you by your drivers.
          </p>
